...
THe input matrices are provided fomr Suitsparse collection repository, in .mat format and are read using the matio library
...
On the bash script, change the INPUT_FILE_NAME according to the file that you want the code to run on. 
